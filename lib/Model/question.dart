class Question {
  ...
  Question.standard(String email, String questionContent, int questionNumber) {
    this.email = email;
  ...
  static List<Question> getDailyQuestions(String email) {
    ...
    questions
        .add(new Question.standard(email, "How are you feeling today?", 2));
    questions.add(
        new Question.standard(email, "Is there anything bothering you?", 3));
    questions.add(new Question.standard(
        email, "How are you feeling about the future?", 4));
    questions
        .add(new Question.standard(email, "Who will you talk to today?", 5));
    questions.add(
        new Question.standard(email, "What do you have planned for today?", 6));
    return questions;
  }
}
